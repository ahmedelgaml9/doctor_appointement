  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <img src="{{asset('adminassets/dist/img/AdminLTELogo.png')}}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light">Doctor Appointement</span>
    </a>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{url('doctors/slots/create')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add Time Slot</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{url('doctors/slots')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Show Slots</p>
                </a>
              </li>
...
<script src="{{ asset('adminasssets/plugins/daterangepicker/daterangepicker.js')}}"></script>
